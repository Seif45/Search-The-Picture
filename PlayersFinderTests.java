...
public class PlayersFinderTests {
	...
	public void test1() {
		...
		Point[] output = test.findPlayers(players, 3, 16);
	...
	public void test2() {
		...
		Point[] output = test.findPlayers(players, 4, 16);
	...
	public void test3() {
		...
		Point[] output = test.findPlayers(players, 8, 9);
	...
	public void test4() {
		...
		Point[] output = test.findPlayers(players, 1, 3);
		Point[] expected = { new Point(5, 5), new Point(5, 5)};
		assertArrayEquals(expected, output);
	}
	
	@Test
	public void testDiffTeam() {
		PlayersFinder test = new PlayersFinder();
		String[] players = {
				"8D88888J8L8E888",
				"88NKMG8N8E8JI88",
		...
		Point[] output = test.findPlayers(players, 7, 3);
		Point[] expected = {};
		assertArrayEquals(expected, output);
	}
	...
	public void testMax() {
		...
		Point[] output = test.findPlayers(players, 1, 1);
	...
	public void testMaxThreshold() {
		...
		Point[] output = test.findPlayers(players, 1, 1000);
		Point[] expected = {};
		assertArrayEquals(expected, output);
	}
	...
	public void testOneSquare() {
		PlayersFinder test = new PlayersFinder();
		String[] players = {"7"};
		Point[] output = test.findPlayers(players, 7, 4);
